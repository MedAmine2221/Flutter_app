...
class _BodyState extends State<Body> {
  ...
  Future<void> _deleteEmployee(String cin) async {
    final url = 'https://771c-102-159-212-28.ngrok.io/supprimer_employee/$cin';
  ...
  Future<void> _deleteSelectedEmployees() async {
    ...
    final url = 'https://771c-102-159-212-28.ngrok.io/supprimer_employees'; // Replace with your actual API endpoint
  ...
  Future<void> searchEmployees() async {
    final url = 'https://771c-102-159-212-28.ngrok.io/rechercher_employee'; // Endpoint de recherche
  ...
  Future<void> registerUser() async {
    final url = 'https://771c-102-159-212-28.ngrok.io/ajouter_employee'; // Replace with your actual API endpoint
    final response = await http.post(
      Uri.parse(url),
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode({
  ...
  Future<void> _updateEmployee(Map<String, dynamic> employee) async {
    final url = 'https://771c-102-159-212-28.ngrok.io/editer_employee/${employee['cin']}';
